...
var blocks = setInterval(function () {
  ...
  } //    px of blocks has been created
  if (blockLastTop < 550 || counter == 0) {
    ...
    var random = Math.floor(Math.random() * 445); // difficulty level 445 max
  ...
  if (drop == 0) {
    //how low falls the character in px / 620 is the best
    if (characterTop < 620) {
